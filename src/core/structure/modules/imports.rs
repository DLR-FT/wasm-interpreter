use crate::{DecodingError, ExternType, FuncType, GlobalType, MemType, TableType, ValidationError, ValidationInfo, core::{reader::WasmReader, structure::modules::indices::{IdxVec, TypeIdx}}};
