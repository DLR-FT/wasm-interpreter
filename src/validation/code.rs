    ...
    loop {
        ...
        match first_instr_byte {
            ...
            FD_EXTENSIONS => {
                ...
                //    let i_types = &["I8X16", "I16X8", "I32X4", "I64X2"];
                //    let f_types = &["F32X4", "F64X2"];
                //    let v_type = "V128";
                //    let viunop = &["ABS", "NEG"];
                //    let vfunop = &["ABS", "NEG", "SQRT", "CEIL", "FLOOR", "TRUC", "NEAREST"];
                //    let vfbinop = &["ADD", "SUB", "MUL", "DIV", "MIN", "MAX", "PMIN", "PMAX"];
                //    let viminmaxop = &["MIN_S", "MIN_U", "MAX_S", "MAX_U"];
                //    let visatbinop = &["ADD_SAT_S", "ADD_SAT_U", "SUB_SAT_S", "SUB_SAT_U"];
                //    let virelop = &["EQ", "NE", "LT_S", "LT_U", "GT_S", "GT_U", "LE_S", "LE_U", "GE_S", "GE_U"];
                //    let vfrelop = &["EQ", "NE", "LT", "GT", "LE", "GE"];
                //    iproduct!(vfrelop.iter(), f_types.iter()).for_each(|(op, f)| println!("{f}_{op}"));
                // }
                // ```
                match second_instr {
                    V128_LOAD => {
                    ...
                    V128_LOAD8_LANE => {
                        ...
                        if lane_idx >= 16 {
                            return Err(Error::InvalidLaneIndex);
                        }
                        if memories.is_empty() {
                            return Err(Error::MemoryIsNotDefined(0));
                        }
                    ...
                    F32X4_RELAXED_MADD | F32X4_RELAXED_MAX | F32X4_RELAXED_MIN | F32X4_RELAXED_NMADD | F64X2_RELAXED_MADD | F64X2_RELAXED_MAX | F64X2_RELAXED_MIN | F64X2_RELAXED_NMADD | I16X8_RELAXED_LANESELECT | I32X4_RELAXED_LANESELECT | I32X4_RELAXED_TRUNC_F32X4_S | I32X4_RELAXED_TRUNC_F32X4_U | I32X4_RELAXED_TRUNC_F64X2_S_ZERO | I32X4_RELAXED_TRUNC_F64X2_U_ZERO | I64X2_RELAXED_LANESELECT | I8X16_RELAXED_LANESELECT | I8X16_RELAXED_SWIZZLE
                    | 154 | 187 | 194 | 256.. => return Err(Error::InvalidMultiByteInstr(first_instr_byte, second_instr)),
                }
            }
