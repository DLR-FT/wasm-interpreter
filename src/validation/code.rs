...
unsafe fn read_instructions(
    ...
    loop {
        ...
        match first_instr_byte {
            ...
            BR => {
                let label_idx = wasm.read_var_u32()?;
            ...
            BR_TABLE => {
                ...
                let max_label_idx =
                    usize::try_from(max_label_idx).expect("architecture to be at least 32 bits");
                ...
                let max_label_arity = stack
                    ...
                    .len();
                for label_idx in &label_vec {
                    let label_idx_as_usize =
                        usize::try_from(*label_idx).expect("architecture to be at least 32 bits");
            ...
            LOCAL_GET => {
                ...
                let local_ty = locals
                    .get(
                        usize::try_from(local_idx.into_inner())
