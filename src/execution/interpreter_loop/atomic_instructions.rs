use crate::{
    ...
    execution::interpreter_loop::{calculate_mem_address, define_instruction, Args},
    instances::MemInst,
    Value,
};
...
define_instruction!(
    ...
    |Args {
        ...
        let data = match mem_inst {
            ...
            MemInst::Shared(shared_mem_inst) => shared_mem_inst.mem.load(idx)?, // TODO: must be tearfree
        };
