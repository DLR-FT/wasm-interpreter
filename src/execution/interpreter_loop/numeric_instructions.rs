...
// i32.unop
define_instruction!(i32_clz, opcode::I32_CLZ, |Args { resumable, .. }| {
...
define_instruction!(i32_ctz, opcode::I32_CTZ, |Args { resumable, .. }| {
    let v1: i32 = resumable.stack.pop_value().try_into().unwrap_validated();
...
// i64.unop
define_instruction!(i64_clz, opcode::I64_CLZ, |Args { resumable, .. }| {
...
define_instruction!(i64_ctz, opcode::I64_CTZ, |Args { resumable, .. }| {
    let v1: i64 = resumable.stack.pop_value().try_into().unwrap_validated();
...
// f32.unop
define_instruction!(f32_abs, opcode::F32_ABS, |Args { resumable, .. }| {
...
define_instruction!(f32_neg, opcode::F32_NEG, |Args { resumable, .. }| {
    let v1: value::F32 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(f32_ceil, opcode::F32_CEIL, |Args { resumable, .. }| {
    let v1: value::F32 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(f32_sqrt, opcode::F32_SQRT, |Args { resumable, .. }| {
    let v1: value::F32 = resumable.stack.pop_value().try_into().unwrap_validated();
...
// f64.unop
define_instruction!(f64_abs, opcode::F64_ABS, |Args { resumable, .. }| {
...
define_instruction!(f64_neg, opcode::F64_NEG, |Args { resumable, .. }| {
    let v1: value::F64 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(f64_ceil, opcode::F64_CEIL, |Args { resumable, .. }| {
    let v1: value::F64 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(f64_sqrt, opcode::F64_SQRT, |Args { resumable, .. }| {
    let v1: value::F64 = resumable.stack.pop_value().try_into().unwrap_validated();
...
// i32.binop
define_instruction!(i32_add, opcode::I32_ADD, |Args { resumable, .. }| {
    let v1: i32 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(i32_sub, opcode::I32_SUB, |Args { resumable, .. }| {
    let v2: i32 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: i32 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(i32_mul, opcode::I32_MUL, |Args { resumable, .. }| {
    let v1: i32 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v2: i32 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(i32_and, opcode::I32_AND, |Args { resumable, .. }| {
    let v1: i32 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v2: i32 = resumable.stack.pop_value().try_into().unwrap_validated();
    let res = v1 & v2;
...
define_instruction!(i32_or, opcode::I32_OR, |Args { resumable, .. }| {
    let v1: i32 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v2: i32 = resumable.stack.pop_value().try_into().unwrap_validated();
    let res = v1 | v2;
...
define_instruction!(i32_xor, opcode::I32_XOR, |Args { resumable, .. }| {
    let v1: i32 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v2: i32 = resumable.stack.pop_value().try_into().unwrap_validated();
    let res = v1 ^ v2;
...
define_instruction!(i32_shl, opcode::I32_SHL, |Args { resumable, .. }| {
    let v1: i32 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v2: i32 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(i32_rotl, opcode::I32_ROTL, |Args { resumable, .. }| {
    let v1: i32 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v2: i32 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(i32_rotr, opcode::I32_ROTR, |Args { resumable, .. }| {
    let v1: i32 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v2: i32 = resumable.stack.pop_value().try_into().unwrap_validated();
...
// i64.binop
define_instruction!(i64_add, opcode::I64_ADD, |Args { resumable, .. }| {
    let v1: i64 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(i64_sub, opcode::I64_SUB, |Args { resumable, .. }| {
    let v2: i64 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: i64 = resumable.stack.pop_value().try_into().unwrap_validated();
    let res = v1.wrapping_sub(v2);
...
define_instruction!(i64_mul, opcode::I64_MUL, |Args { resumable, .. }| {
    let v1: i64 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v2: i64 = resumable.stack.pop_value().try_into().unwrap_validated();
    let res = v1.wrapping_mul(v2);
...
define_instruction!(i64_and, opcode::I64_AND, |Args { resumable, .. }| {
    let v2: i64 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: i64 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(i64_or, opcode::I64_OR, |Args { resumable, .. }| {
    let v2: i64 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: i64 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(i64_xor, opcode::I64_XOR, |Args { resumable, .. }| {
    let v2: i64 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: i64 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(i64_shl, opcode::I64_SHL, |Args { resumable, .. }| {
    let v2: i64 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: i64 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(i64_rotl, opcode::I64_ROTL, |Args { resumable, .. }| {
    let v2: i64 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: i64 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(i64_rotr, opcode::I64_ROTR, |Args { resumable, .. }| {
    let v2: i64 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: i64 = resumable.stack.pop_value().try_into().unwrap_validated();
...
// f32.binop
define_instruction!(f32_add, opcode::F32_ADD, |Args { resumable, .. }| {
...
define_instruction!(f32_sub, opcode::F32_SUB, |Args { resumable, .. }| {
    let v2: value::F32 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: value::F32 = resumable.stack.pop_value().try_into().unwrap_validated();
    let res: value::F32 = v1 - v2;
...
define_instruction!(f32_mul, opcode::F32_MUL, |Args { resumable, .. }| {
    let v2: value::F32 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: value::F32 = resumable.stack.pop_value().try_into().unwrap_validated();
    let res: value::F32 = v1 * v2;
...
define_instruction!(f32_div, opcode::F32_DIV, |Args { resumable, .. }| {
    let v2: value::F32 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: value::F32 = resumable.stack.pop_value().try_into().unwrap_validated();
    let res: value::F32 = v1 / v2;
...
define_instruction!(f32_min, opcode::F32_MIN, |Args { resumable, .. }| {
    let v2: value::F32 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: value::F32 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(f32_max, opcode::F32_MAX, |Args { resumable, .. }| {
    let v2: value::F32 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: value::F32 = resumable.stack.pop_value().try_into().unwrap_validated();
...
// f64.binop
define_instruction!(f64_add, opcode::F64_ADD, |Args { resumable, .. }| {
...
define_instruction!(f64_sub, opcode::F64_SUB, |Args { resumable, .. }| {
    let v2: value::F64 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: value::F64 = resumable.stack.pop_value().try_into().unwrap_validated();
    let res: value::F64 = v1 - v2;
...
define_instruction!(f64_mul, opcode::F64_MUL, |Args { resumable, .. }| {
    let v2: value::F64 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: value::F64 = resumable.stack.pop_value().try_into().unwrap_validated();
    let res: value::F64 = v1 * v2;
...
define_instruction!(f64_div, opcode::F64_DIV, |Args { resumable, .. }| {
    let v2: value::F64 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: value::F64 = resumable.stack.pop_value().try_into().unwrap_validated();
    let res: value::F64 = v1 / v2;
...
define_instruction!(f64_min, opcode::F64_MIN, |Args { resumable, .. }| {
    let v2: value::F64 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: value::F64 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(f64_max, opcode::F64_MAX, |Args { resumable, .. }| {
    let v2: value::F64 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: value::F64 = resumable.stack.pop_value().try_into().unwrap_validated();
...
// i32.testop
define_instruction!(i32_eqz, opcode::I32_EQZ, |Args { resumable, .. }| {
    let v1: i32 = resumable.stack.pop_value().try_into().unwrap_validated();
...
// i64.testop
define_instruction!(i64_eqz, opcode::I64_EQZ, |Args { resumable, .. }| {
    let v1: i64 = resumable.stack.pop_value().try_into().unwrap_validated();
...
// i32.relop
define_instruction!(i32_eq, opcode::I32_EQ, |Args { resumable, .. }| {
    let v2: i32 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: i32 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(i32_ne, opcode::I32_NE, |Args { resumable, .. }| {
    let v2: i32 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: i32 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(i32_lt_s, opcode::I32_LT_S, |Args { resumable, .. }| {
    let v2: i32 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: i32 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(i32_lt_u, opcode::I32_LT_U, |Args { resumable, .. }| {
    let v2: i32 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: i32 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(i32_gt_s, opcode::I32_GT_S, |Args { resumable, .. }| {
    let v2: i32 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: i32 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(i32_gt_u, opcode::I32_GT_U, |Args { resumable, .. }| {
    let v2: i32 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: i32 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(i32_le_s, opcode::I32_LE_S, |Args { resumable, .. }| {
    let v2: i32 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: i32 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(i32_le_u, opcode::I32_LE_U, |Args { resumable, .. }| {
    let v2: i32 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: i32 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(i32_ge_s, opcode::I32_GE_S, |Args { resumable, .. }| {
    let v2: i32 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: i32 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(i32_ge_u, opcode::I32_GE_U, |Args { resumable, .. }| {
    let v2: i32 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: i32 = resumable.stack.pop_value().try_into().unwrap_validated();
...
// i64.relop
define_instruction!(i64_eq, opcode::I64_EQ, |Args { resumable, .. }| {
    let v2: i64 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: i64 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(i64_ne, opcode::I64_NE, |Args { resumable, .. }| {
    let v2: i64 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: i64 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(i64_lt_s, opcode::I64_LT_S, |Args { resumable, .. }| {
    let v2: i64 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: i64 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(i64_lt_u, opcode::I64_LT_U, |Args { resumable, .. }| {
    let v2: i64 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: i64 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(i64_gt_s, opcode::I64_GT_S, |Args { resumable, .. }| {
    let v2: i64 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: i64 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(i64_gt_u, opcode::I64_GT_U, |Args { resumable, .. }| {
    let v2: i64 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: i64 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(i64_le_s, opcode::I64_LE_S, |Args { resumable, .. }| {
    let v2: i64 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: i64 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(i64_le_u, opcode::I64_LE_U, |Args { resumable, .. }| {
    let v2: i64 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: i64 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(i64_ge_s, opcode::I64_GE_S, |Args { resumable, .. }| {
    let v2: i64 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: i64 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(i64_ge_u, opcode::I64_GE_U, |Args { resumable, .. }| {
    let v2: i64 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: i64 = resumable.stack.pop_value().try_into().unwrap_validated();
...
// f32.relop
define_instruction!(f32_eq, opcode::F32_EQ, |Args { resumable, .. }| {
    let v2: value::F32 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: value::F32 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(f32_ne, opcode::F32_NE, |Args { resumable, .. }| {
    let v2: value::F32 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: value::F32 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(f32_lt, opcode::F32_LT, |Args { resumable, .. }| {
    let v2: value::F32 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: value::F32 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(f32_gt, opcode::F32_GT, |Args { resumable, .. }| {
    let v2: value::F32 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: value::F32 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(f32_le, opcode::F32_LE, |Args { resumable, .. }| {
    let v2: value::F32 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: value::F32 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(f32_ge, opcode::F32_GE, |Args { resumable, .. }| {
    let v2: value::F32 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: value::F32 = resumable.stack.pop_value().try_into().unwrap_validated();
...
// f64.relop
define_instruction!(f64_eq, opcode::F64_EQ, |Args { resumable, .. }| {
    let v2: value::F64 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: value::F64 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(f64_ne, opcode::F64_NE, |Args { resumable, .. }| {
    let v2: value::F64 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: value::F64 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(f64_lt, opcode::F64_LT, |Args { resumable, .. }| {
    let v2: value::F64 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: value::F64 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(f64_gt, opcode::F64_GT, |Args { resumable, .. }| {
    let v2: value::F64 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: value::F64 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(f64_le, opcode::F64_LE, |Args { resumable, .. }| {
    let v2: value::F64 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: value::F64 = resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction!(f64_ge, opcode::F64_GE, |Args { resumable, .. }| {
    let v2: value::F64 = resumable.stack.pop_value().try_into().unwrap_validated();
    let v1: value::F64 = resumable.stack.pop_value().try_into().unwrap_validated();
