...
/// implemented through a shared ref to the internal vector, with [`AtomicU8`] to achieve interior
/// mutability without undefined behavior.
///
...
impl<const PAGE_SIZE: usize> LinearMemory<PAGE_SIZE> {
    ...
    pub fn copy(
        ...
        if source_index < destination_index {
            ...
            // if source index is bigger than destination index, forward processing copy handles
            // overlaps just fine
