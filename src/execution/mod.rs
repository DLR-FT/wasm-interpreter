    ...
    H: HookSet,
{
    ...
    pub fn add_module(&mut self, module_name: &str, validation_info: &'_ ValidationInfo<'b>) {
    ...
    pub fn invoke<Param: InteropValueList, Returns: InteropValueList>(
        ...
        stack.push_stackframe(module_idx, func_idx, func_ty, locals, usize::MAX);
    ...
    pub fn invoke_dynamic(
        ...
        stack.push_stackframe(module_idx, func_idx, &func_ty, locals, 0);
