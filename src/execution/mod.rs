    ...
    H: HookSet,
{
    ...
    //     validation_info: &'_ ValidationInfo<'b>,
    // ) -> CustomResult<()> {
    //     Self::init_store_v2(self, validation_info)?;
    ...
    // fn init_store_v2(store: &mut Store, validation_info: &ValidationInfo) -> CustomResult<()> {
    ...
    //     //     modules: Default::default(), // TODO: DO NOT FORGET ABOUT THE PASSIVE ELEM INDEXES!!!!!!!!!!!!!!!1!
