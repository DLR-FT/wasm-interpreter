...
define_instruction_fn! {
    ...
    |args: Args| {
        ...
        let relative_address: u32 = args.resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction_fn! {
    ...
    |args: Args| {
        ...
        let data_to_store: u32 = args.resumable.stack.pop_value().try_into().unwrap_validated();
        let relative_address: u32 = args.resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction_fn! {
    ...
    |args: Args| {
        ...
        let data_to_store: u64 = args.resumable.stack.pop_value().try_into().unwrap_validated();
        let relative_address: u32 = args.resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction_fn! {
    ...
    |args: Args| {
        ...
        let data_to_store: F32 = args.resumable.stack.pop_value().try_into().unwrap_validated();
        let relative_address: u32 = args.resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction_fn! {
    ...
    |args: Args| {
        ...
        let data_to_store: F64 = args.resumable.stack.pop_value().try_into().unwrap_validated();
        let relative_address: u32 = args.resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction_fn! {
    ...
    |args: Args| {
        ...
        let data_to_store: i32 = args.resumable.stack.pop_value().try_into().unwrap_validated();
        let relative_address: u32 = args.resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction_fn! {
    ...
    |args: Args| {
        ...
        let data_to_store: i64 = args.resumable.stack.pop_value().try_into().unwrap_validated();
        let relative_address: u32 = args.resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction_fn! {
    ...
    |args: Args| {
        ...
        let n: u32 = args.resumable.stack.pop_value().try_into().unwrap_validated();
        ...
        if let Some(fuel) = &mut args.resumable.maybe_fuel {
            if *fuel >= cost {
                *fuel -= cost;
                ...
                args.resumable.stack.push_value(Value::I32(n)).unwrap_validated(); // we are pushing back what was just popped, this can't panic.
...
define_instruction_fn! {
    ...
    |args: Args| {
        ...
        let val: i32 = args.resumable.stack.pop_value().try_into().unwrap_validated();

        if !(0..=255).contains(&val) {
            warn!("Value for memory.fill does not fit in a byte ({val})");
        }

        let d: i32 = args.resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction_fn! {
    ...
    |args: Args| {
        ...
        let s: i32 = args.resumable.stack.pop_value().try_into().unwrap_validated();
        let d: i32 = args.resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction_fn! {
    ...
    |args: Args| {
        ...
        let s: u32 = args.resumable.stack.pop_value().try_into().unwrap_validated();
        let d: u32 = args.resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction_fn! {
    ...
    |args: Args| {
        ...
        //    current store.
        unsafe { data_drop(args.modules, &mut args.store_inner.data, *args.current_module, data_idx) };
        Ok(ControlFlow::Continue(()))
    }
}
