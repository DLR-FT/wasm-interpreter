...
define_instruction_fn! {
    ...
    |args: Args| {
        ...
        let i: i32 = args.resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction_fn! {
    ...
    |args: Args| {
        ...
        let val: Ref = args.resumable.stack.pop_value().try_into().unwrap_validated();
        let i: i32 = args.resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction_fn! {
    ...
    |args: Args| {
        ...
        let len: u32 = args.resumable.stack.pop_value().try_into().unwrap_validated();
        ...
        let val: Ref = args.resumable.stack.pop_value().try_into().unwrap_validated();
        let dst: u32 = args.resumable.stack.pop_value().try_into().unwrap_validated();
...
define_instruction_fn! {
    ...
    |args: Args| {
        ...
        // current store. Therefore, it is valid in the current
        // store.
        let tab_x_elem_len = unsafe { args.store_inner.tables.get(table_addr_x) }.elem.len();
        // SAFETY: This table address was just read from the
        // current store. Therefore, it is valid in the current
        // store.
        let tab_y_elem_len = unsafe { args.store_inner.tables.get(table_addr_y) }.elem.len();

        let n: u32 = args.resumable.stack.pop_value().try_into().unwrap_validated(); // size
        ...
        let s: u32 = args.resumable.stack.pop_value().try_into().unwrap_validated(); // source
        let d: u32 = args.resumable.stack.pop_value().try_into().unwrap_validated(); // destination
...
define_instruction_fn! {
    ...
    |args: Args| {
        ...
        let s: i32 = args.resumable.stack.pop_value().try_into().unwrap_validated(); // offset
        let d: i32 = args.resumable.stack.pop_value().try_into().unwrap_validated(); // dst
