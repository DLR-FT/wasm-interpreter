...
define_instruction_fn! {
    ...
    |Args {
        ...
        let constant = wasm.decode_var_i32();
...
define_instruction_fn! {
    ...
    |Args {
        ...
        let constant = wasm.decode_var_i64();
...
define_instruction_fn! {
    ...
    |Args {
        ...
        let constant = F32::from_bits(wasm.decode_f32());
...
define_instruction_fn! {
    ...
    |Args {
        ...
        let constant = F64::from_bits(wasm.decode_f64_unchecked());
