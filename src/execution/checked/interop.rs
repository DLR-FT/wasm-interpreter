...
impl StoredInteropValue for StoredRefExtern {
...
#[derive(Debug, Copy, Clone, PartialEq)]
pub struct StoredRefExtern(pub Option<Stored<ExternAddr>>);

impl From<StoredRefExtern> for StoredValue {
    fn from(value: StoredRefExtern) -> Self {
        match value.0 {
...
impl TryFrom<StoredValue> for StoredRefExtern {
    type Error = ValueTypeMismatchError;
