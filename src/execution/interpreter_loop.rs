            ...
            FC_EXTENSIONS => {
                ...
                match second_instr_byte {
                    ...
                    MEMORY_COPY => {
                        ...
                        let src_mem = &store.memories[src];
                        let dest_mem = &store.memories[dst];
