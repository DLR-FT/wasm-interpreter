...
name = 'actions/document/edit_section/stream_edit_section.jinja.html'
...
def root(context, missing=missing):
    ...
    yield '">\n  <template>\n    '
    template = environment.get_template('screens/document/document/frame_section_form.jinja', 'actions/document/edit_section/stream_edit_section.jinja.html')
