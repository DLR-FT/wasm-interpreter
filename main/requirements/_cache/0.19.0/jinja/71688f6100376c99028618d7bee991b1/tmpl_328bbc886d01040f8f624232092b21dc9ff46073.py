...
name = 'screens/git/node/document.jinja'
...
def root(context, missing=missing):
    ...
    pass
    template = environment.get_template('components/badge/index.jinja', 'screens/git/node/document.jinja')
    ...
    if ((undefined(name='tab') if l_0_tab is missing else l_0_tab) == 'diff'):
        ...
        if (not t_2((undefined(name='document_change') if l_0_document_change is missing else l_0_document_change))):
            ...
            if (not t_2(environment.getattr((undefined(name='document_change') if l_0_document_change is missing else l_0_document_change), 'document_token'))):
                ...
                pass
                template = environment.get_template('screens/git/sync/button.jinja', 'screens/git/node/document.jinja')
                ...
                l_1_uid = missing
    yield '</summary>\n\n  '
    template = environment.get_template('screens/git/fields/document_fields.jinja', 'screens/git/node/document.jinja')
