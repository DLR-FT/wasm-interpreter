...
def root(context, missing=missing):
    ...
    if environment.getattr(environment.getattr((undefined(name='view_object') if l_0_view_object is missing else l_0_view_object), 'project_config'), 'is_running_on_server'):
        ...
        l_1_header__actions_template = 'screens/project_index/action_list.jinja'
        pass
        template = environment.get_template('components/header/actions_wrapper.jinja', 'screens/project_index/actions.jinja')
