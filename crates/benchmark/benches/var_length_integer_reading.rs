...
fn criterion_benchmark(c: &mut Criterion) {
    ...
    for sample in samples_by_num_bytes {
        ...
        // The optimal function is chosen based on the sample length
        group.bench_with_input(
...
/// Note: At the time of writing, the compiler does not unroll this loop making
/// this function even slower than [`bounded_loop`].
///
/// # Safety
/// The caller must guarantee that there is a valid variable-length u32 at the given index.
#[inline(always)]
