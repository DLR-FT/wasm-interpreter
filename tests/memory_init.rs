...
use wasm::error::RuntimeOrHostError;
...
(module
  ...
  "#;
    ...
    .expect("instantiation failed");
    assert_error!(i, get_func!(i, "test"), (), Result<(), RuntimeOrHostError<Infallible>>, (), (), RuntimeError::Trap(TrapError::MemoryOrDataAccessOutOfBounds).into());
}
