...
pub fn i32_wrap_i64_let_it_die() {
    ...
    assert_eq!(-1, instance.invoke_typed(function, -1).unwrap());
}
...
pub fn i32_wrap_i64() {
    ...
    assert_eq!(-1, instance.invoke_typed(function, -1_i64).unwrap());
    assert_eq!(
        -100000,
        instance.invoke_typed(function, -100000_i64).unwrap()
    );
    assert_eq!(
        0x80000000_u32 as i32,
        instance.invoke_typed(function, 0x80000000_i64).unwrap()
    );
    assert_eq!(
        0x7fffffff,
        instance
            .invoke_typed(function, 0xffffffff7fffffff_u64 as i64)
            .unwrap()
    );
    assert_eq!(
        0x00000000,
        instance
            .invoke_typed(function, 0xffffffff00000000_u64 as i64)
            .unwrap()
    );
    assert_eq!(
        0xffffffff_u32 as i32,
        instance
            .invoke_typed(function, 0xfffffffeffffffff_u64 as i64)
            .unwrap()
    );
    assert_eq!(
        0x00000001,
        instance
            .invoke_typed(function, 0xffffffff00000001_u64 as i64)
            .unwrap()
    );
    assert_eq!(0, instance.invoke_typed(function, 0_i64).unwrap());
    assert_eq!(
        0x9abcdef0_u32 as i32,
        instance
            .invoke_typed(function, 1311768467463790320_i64)
            .unwrap()
    );
    assert_eq!(
        0xffffffff_u32 as i32,
        instance
            .invoke_typed(function, 0x00000000ffffffff_i64)
            .unwrap()
    );
    assert_eq!(
        0x00000000,
        instance
            .invoke_typed(function, 0x0000000100000000_i64)
            .unwrap()
    );
    assert_eq!(
        0x00000001,
        instance
            .invoke_typed(function, 0x0000000100000001_i64)
            .unwrap()
    );
}
...
pub fn i32_trunc_f32_s() {
    ...
    assert_eq!(0, instance.invoke_typed(function, 0.0_f32).unwrap());
    assert_eq!(0, instance.invoke_typed(function, -0.0_f32).unwrap());
    assert_eq!(
        0,
        instance
            .invoke_typed(function, hexf32!("0x1p-149"))
            .unwrap()
    );
    assert_eq!(
        0,
    ...
    assert_eq!(1, instance.invoke_typed(function, 1.0_f32).unwrap());
    assert_eq!(
        1,
        instance
            .invoke_typed(function, hexf32!("0x1.19999ap+0"))
            .unwrap()
    );
    assert_eq!(1, instance.invoke_typed(function, 1.5_f32).unwrap());
    assert_eq!(-1, instance.invoke_typed(function, -1.0_f32).unwrap());
    assert_eq!(
        -1,
        instance
    ...
    assert_eq!(-1, instance.invoke_typed(function, -1.5_f32).unwrap());
    assert_eq!(-1, instance.invoke_typed(function, -1.9_f32).unwrap());
    assert_eq!(-2, instance.invoke_typed(function, -2.0_f32).unwrap());
    assert_eq!(
        2147483520,
        instance.invoke_typed(function, 2147483520.0_f32).unwrap()
    );
    assert_eq!(
        2147483648_u32 as i32,
        instance.invoke_typed(function, -2147483648.0_f32).unwrap()
    );
    assert_eq!(
        RuntimeError::Trap(TrapError::UnrepresentableResult),
        instance
            .invoke_typed::<f32, i32>(function, 2147483648.0_f32)
            .err()
            .unwrap()
    );
    assert_eq!(
        RuntimeError::Trap(TrapError::UnrepresentableResult),
        instance
            .invoke_typed::<f32, i32>(function, -2147483904.0_f32)
            .err()
            .unwrap()
    );
    assert_eq!(
        RuntimeError::Trap(TrapError::UnrepresentableResult),
        instance
            .invoke_typed::<f32, i32>(function, f32::INFINITY)
            .err()
            .unwrap()
    );
    assert_eq!(
        RuntimeError::Trap(TrapError::UnrepresentableResult),
        instance
            .invoke_typed::<f32, i32>(function, f32::NEG_INFINITY)
            .err()
            .unwrap()
    );
    assert_eq!(
        ...
        instance
            .invoke_typed::<f32, i32>(function, f32::NAN)
            .err()
            .unwrap()
    );
    assert_eq!(
...
pub fn i32_trunc_f32_u() {
    ...
    assert_eq!(
        -2147483648,
        instance.invoke_typed(function, 2147483648_f32).unwrap()
    );
    assert_eq!(
        -256,
        instance.invoke_typed(function, 4294967040.0_f32).unwrap()
    );
    assert_eq!(
        0,
        instance
            .invoke_typed(function, hexf32!("-0x1.ccccccp-1"))
            .unwrap()
    );
    assert_eq!(
        0,
        instance
            .invoke_typed(function, hexf32!("-0x1.fffffep-1"))
            .unwrap()
    );
    assert_eq!(
        RuntimeError::Trap(TrapError::UnrepresentableResult),
        instance
            .invoke_typed::<f32, i32>(function, 4294967296.0_f32)
            .err()
            .unwrap()
    );
    assert_eq!(
        RuntimeError::Trap(TrapError::UnrepresentableResult),
        instance
            .invoke_typed::<f32, i32>(function, -1.0)
            .err()
            .unwrap()
    );
    assert_eq!(
...
pub fn i32_trunc_f64_s() {
    ...
    assert_eq!(0, instance.invoke_typed(function, 0.0_f64).unwrap());
    assert_eq!(0, instance.invoke_typed(function, -0.0_f64).unwrap());
    assert_eq!(
        0,
        instance
            .invoke_typed(function, hexf64!("0x0.0000000000001p-1022"))
            .unwrap()
    );
    assert_eq!(
        0,
    ...
    assert_eq!(1, instance.invoke_typed(function, 1.0_f64).unwrap());
    assert_eq!(
        1,
        instance
            .invoke_typed(function, hexf64!("0x1.199999999999ap+0"))
            .unwrap()
    );
    assert_eq!(1, instance.invoke_typed(function, 1.5_f64).unwrap());
    assert_eq!(-1, instance.invoke_typed(function, -1.0_f64).unwrap());
    assert_eq!(
        -1,
        instance
    ...
    assert_eq!(-1, instance.invoke_typed(function, -1.5_f64).unwrap());
    assert_eq!(-1, instance.invoke_typed(function, -1.9_f64).unwrap());
    assert_eq!(-2, instance.invoke_typed(function, -2.0_f64).unwrap());
    assert_eq!(
        2147483647,
        instance.invoke_typed(function, 2147483647.0_f64).unwrap()
    );
    assert_eq!(
        -2147483648,
        instance.invoke_typed(function, -2147483648.0_f64).unwrap()
    );
    assert_eq!(
        -2147483648,
        instance.invoke_typed(function, -2147483648.9_f64).unwrap()
    );
    assert_eq!(
        -2147483648,
        instance.invoke_typed(function, -2147483648.9_f64).unwrap()
    ...
    assert_eq!(
        RuntimeError::Trap(TrapError::UnrepresentableResult),
        instance
            .invoke_typed::<f64, i32>(function, 2147483648.0)
            .err()
            .unwrap()
    );
    assert_eq!(
        RuntimeError::Trap(TrapError::UnrepresentableResult),
        instance
            .invoke_typed::<f64, i32>(function, -2147483649.0)
            .err()
            .unwrap()
    );
    assert_eq!(
        RuntimeError::Trap(TrapError::UnrepresentableResult),
        instance
            .invoke_typed::<f64, i32>(function, f64::INFINITY)
            .err()
            .unwrap()
    );
    assert_eq!(
        RuntimeError::Trap(TrapError::UnrepresentableResult),
        instance
            .invoke_typed::<f64, i32>(function, f64::NEG_INFINITY)
            .err()
            .unwrap()
    );
    assert_eq!(
        RuntimeError::Trap(TrapError::BadConversionToInteger),
        instance
            .invoke_typed::<f64, i32>(function, f64::NAN)
            .err()
            .unwrap()
    );
    assert_eq!(
...
pub fn i32_trunc_f64_u() {
    ...
    assert_eq!(
        -2147483648,
        instance.invoke_typed(function, 2147483648_f64).unwrap()
    );
    assert_eq!(
        -1,
        instance.invoke_typed(function, 4294967295.0_f64).unwrap()
    );
    assert_eq!(
        0,
        instance
            .invoke_typed(function, hexf64!("-0x1.ccccccccccccdp-1"))
            .unwrap()
    );
    assert_eq!(
        0,
        instance
            .invoke_typed(function, hexf64!("-0x1.fffffffffffffp-1"))
            .unwrap()
    );
    assert_eq!(100000000, instance.invoke_typed(function, 1e8_f64).unwrap());
    assert_eq!(0, instance.invoke_typed(function, -0.9).unwrap());
    assert_eq!(
        4294967295_u32 as i32,
        instance.invoke_typed(function, 4294967295.9_f64).unwrap()
    );
    assert_eq!(
        RuntimeError::Trap(TrapError::UnrepresentableResult),
        instance
            .invoke_typed::<f64, i32>(function, 4294967296.0)
            .err()
            .unwrap()
    );
    assert_eq!(
        RuntimeError::Trap(TrapError::UnrepresentableResult),
        instance
            .invoke_typed::<f64, i32>(function, -1.0)
            .err()
            .unwrap()
    );
    assert_eq!(
        RuntimeError::Trap(TrapError::UnrepresentableResult),
        instance
            .invoke_typed::<f64, i32>(function, 1e16)
            .err()
            .unwrap()
    );
    assert_eq!(
        RuntimeError::Trap(TrapError::UnrepresentableResult),
        instance
            .invoke_typed::<f64, i32>(function, 1e30)
            .err()
            .unwrap()
    );
    assert_eq!(
        RuntimeError::Trap(TrapError::UnrepresentableResult),
        instance
            .invoke_typed::<f64, i32>(function, 9223372036854775808_f64)
            .err()
            .unwrap()
    );
    assert_eq!(
...
pub fn i64_extend_i32_s() {
    ...
    assert_eq!(0_i64, instance.invoke_typed(function, 0).unwrap());
    assert_eq!(10000_i64, instance.invoke_typed(function, 10000).unwrap());
    assert_eq!(-10000_i64, instance.invoke_typed(function, -10000).unwrap());
    assert_eq!(-1_i64, instance.invoke_typed(function, -1).unwrap());
    assert_eq!(
        0x000000007fffffff_i64,
        instance.invoke_typed(function, 0x7fffffff).unwrap()
    );
    assert_eq!(
        0xffffffff80000000_u64 as i64,
        instance
            .invoke_typed(function, 0x80000000_u32 as i32)
            .unwrap()
    );
}
...
pub fn i64_extend_i32_u() {
    ...
    assert_eq!(
        ...
        instance.invoke_typed(function, -10000).unwrap()
    );
    assert_eq!(0xffffffff_i64, instance.invoke_typed(function, -1).unwrap());
    assert_eq!(
        0x000000007fffffff_i64,
        instance.invoke_typed(function, 0x7fffffff).unwrap()
    );
...
pub fn i64_trunc_f32_s() {
    ...
    assert_eq!(0_i64, instance.invoke_typed(function, 0.0_f32).unwrap());
    assert_eq!(0_i64, instance.invoke_typed(function, -0.0_f32).unwrap());
    assert_eq!(
        0_i64,
        instance
    ...
    assert_eq!(1_i64, instance.invoke_typed(function, 1.0_f32).unwrap());
    assert_eq!(
        1_i64,
        instance
            .invoke_typed(function, hexf32!("0x1.19999ap+0"))
    ...
    assert_eq!(1_i64, instance.invoke_typed(function, 1.5_f32).unwrap());
    assert_eq!(-1_i64, instance.invoke_typed(function, -1.0_f32).unwrap());
    assert_eq!(
        -1_i64,
        instance
    ...
    assert_eq!(-1_i64, instance.invoke_typed(function, -1.5_f32).unwrap());
    assert_eq!(-1_i64, instance.invoke_typed(function, -1.9_f32).unwrap());
    assert_eq!(-2_i64, instance.invoke_typed(function, -2.0_f32).unwrap());
    assert_eq!(
        4294967296_i64,
        instance.invoke_typed(function, 4294967296_f32).unwrap()
    );
    assert_eq!(
        -4294967296_i64,
        instance.invoke_typed(function, -4294967296_f32).unwrap()
    ...
    assert_eq!(
        ...
        instance
            .invoke_typed(function, 9223371487098961920.0_f32)
            .unwrap()
    );
    assert_eq!(
        -9223372036854775808_i64,
        instance
            .invoke_typed(function, -9223372036854775808.0_f32)
            .unwrap()
    );
    assert_eq!(
        RuntimeError::Trap(TrapError::UnrepresentableResult),
        instance
            .invoke_typed::<f32, i64>(function, 9223372036854775808.0_f32)
            .err()
            .unwrap()
    );
    assert_eq!(
        RuntimeError::Trap(TrapError::UnrepresentableResult),
        instance
            .invoke_typed::<f32, i64>(function, -9223373136366403584.0_f32)
            .err()
            .unwrap()
    );
    assert_eq!(
        RuntimeError::Trap(TrapError::UnrepresentableResult),
        instance
            .invoke_typed::<f32, i64>(function, f32::INFINITY)
            .err()
            .unwrap()
    );
    assert_eq!(
        RuntimeError::Trap(TrapError::UnrepresentableResult),
        instance
            .invoke_typed::<f32, i64>(function, f32::NEG_INFINITY)
            .err()
            .unwrap()
    );
    assert_eq!(
        RuntimeError::Trap(TrapError::BadConversionToInteger),
        instance
            .invoke_typed::<f32, i64>(function, f32::NAN)
            .err()
            .unwrap()
    );
    assert_eq!(
...
pub fn i64_trunc_f32_u() {
    ...
    assert_eq!(
        -1099511627776_i64,
        instance
            .invoke_typed(function, 18446742974197923840.0_f32)
            .unwrap()
    );
    assert_eq!(
        1_i64,
    ...
    assert_eq!(
        RuntimeError::Trap(TrapError::UnrepresentableResult),
        instance
            .invoke_typed::<f32, i64>(function, 18446744073709551616.0_f32)
            .err()
            .unwrap()
    );
    assert_eq!(
        RuntimeError::Trap(TrapError::UnrepresentableResult),
        instance
            .invoke_typed::<f32, i64>(function, -1.0_f32)
            .err()
            .unwrap()
    );
    assert_eq!(
...
pub fn i64_trunc_f64_s() {
    ...
    assert_eq!(0_i64, instance.invoke_typed(function, 0.0_f64).unwrap());
    assert_eq!(0_i64, instance.invoke_typed(function, -0.0_f64).unwrap());
    assert_eq!(
        0_i64,
        instance
    ...
    assert_eq!(1_i64, instance.invoke_typed(function, 1.0_f64).unwrap());
    assert_eq!(
        1_i64,
        instance
            .invoke_typed(function, hexf64!("0x1.199999999999ap+0"))
    ...
    assert_eq!(1_i64, instance.invoke_typed(function, 1.5_f64).unwrap());
    assert_eq!(-1_i64, instance.invoke_typed(function, -1.0_f64).unwrap());
    assert_eq!(
        -1_i64,
        instance
    ...
    assert_eq!(-1_i64, instance.invoke_typed(function, -1.5_f64).unwrap());
    assert_eq!(-1_i64, instance.invoke_typed(function, -1.9_f64).unwrap());
    assert_eq!(-2_i64, instance.invoke_typed(function, -2.0_f64).unwrap());
    assert_eq!(
        4294967296_i64,
        instance.invoke_typed(function, 4294967296_f64).unwrap()
    );
    assert_eq!(
        -4294967296_i64,
        instance.invoke_typed(function, -4294967296_f64).unwrap()
    ...
    assert_eq!(
        ...
        instance
            .invoke_typed(function, 9223372036854774784.0_f64)
            .unwrap()
    );
    assert_eq!(
        -9223372036854775808_i64,
        instance
            .invoke_typed(function, -9223372036854775808.0_f64)
            .unwrap()
    );
    assert_eq!(
        RuntimeError::Trap(TrapError::UnrepresentableResult),
        instance
            .invoke_typed::<f64, i64>(function, 9223372036854775808.0_f64)
            .err()
            .unwrap()
    );
    assert_eq!(
        RuntimeError::Trap(TrapError::UnrepresentableResult),
        instance
            .invoke_typed::<f64, i64>(function, -9223372036854777856.0_f64)
            .err()
            .unwrap()
    );
    assert_eq!(
        RuntimeError::Trap(TrapError::UnrepresentableResult),
        instance
            .invoke_typed::<f64, i64>(function, f64::INFINITY)
            .err()
            .unwrap()
    );
    assert_eq!(
        RuntimeError::Trap(TrapError::UnrepresentableResult),
        instance
            .invoke_typed::<f64, i64>(function, f64::NEG_INFINITY)
            .err()
            .unwrap()
    );
    assert_eq!(
        RuntimeError::Trap(TrapError::BadConversionToInteger),
        instance
            .invoke_typed::<f64, i64>(function, f64::NAN)
            .err()
            .unwrap()
    );
    assert_eq!(
...
pub fn i64_trunc_f64_u() {
    ...
    assert_eq!(
        0xffffffff_i64,
        instance.invoke_typed(function, 4294967295_f64).unwrap()
    );
    assert_eq!(
        0x100000000_i64,
        instance.invoke_typed(function, 4294967296_f64).unwrap()
    ...
    assert_eq!(
        -2048_i64,
        instance
            .invoke_typed(function, 18446744073709549568.0_f64)
            .unwrap()
    );
    assert_eq!(
        0_i64,
    ...
    assert_eq!(
        100000000_i64,
        instance.invoke_typed(function, 1e8_f64).unwrap()
    );
    assert_eq!(
        10000000000000000_i64,
        instance.invoke_typed(function, 1e16_f64).unwrap()
    );
    assert_eq!(
        -9223372036854775808_i64,
        instance
            .invoke_typed(function, 9223372036854775808_f64)
            .unwrap()
    );
    assert_eq!(
        RuntimeError::Trap(TrapError::UnrepresentableResult),
        instance
            .invoke_typed::<f64, i64>(function, 18446744073709551616.0_f64)
            .err()
            .unwrap()
    );
    assert_eq!(
        RuntimeError::Trap(TrapError::UnrepresentableResult),
        instance
            .invoke_typed::<f64, i64>(function, -1_f64)
            .err()
            .unwrap()
    );
    assert_eq!(
...
pub fn f32_convert_i32_s() {
    ...
    assert_eq!(1.0_f32, instance.invoke_typed(function, 1).unwrap());
    assert_eq!(-1.0_f32, instance.invoke_typed(function, -1).unwrap());
    assert_eq!(0.0_f32, instance.invoke_typed(function, 0).unwrap());
    assert_eq!(
        2147483648_f32,
        instance.invoke_typed(function, 2147483647).unwrap()
    );
    assert_eq!(
        -2147483648_f32,
        instance.invoke_typed(function, -2147483648).unwrap()
    );
    assert_eq!(
        hexf32!("0x1.26580cp+30"),
        instance.invoke_typed(function, 1234567890).unwrap()
    );
}
...
pub fn f32_convert_i32_u() {
    ...
    assert_eq!(
        ...
        instance.invoke_typed(function, 0x12345678).unwrap()
    );
    assert_eq!(
        4294967296.0_f32,
        instance
            .invoke_typed(function, 0xffffffff_u32 as i32)
            .unwrap()
    );
    assert_eq!(
        hexf32!("0x1.000000p+31"),
        instance
            .invoke_typed(function, 0x80000080_u32 as i32)
            .unwrap()
    );
    assert_eq!(
        hexf32!("0x1.000002p+31"),
        instance
            .invoke_typed(function, 0x80000081_u32 as i32)
            .unwrap()
    );
    assert_eq!(
        hexf32!("0x1.000002p+31"),
        instance
            .invoke_typed(function, 0x80000082_u32 as i32)
            .unwrap()
    );
    assert_eq!(
        hexf32!("0x1.fffffcp+31"),
        instance
            .invoke_typed(function, 0xfffffe80_u32 as i32)
            .unwrap()
    );
    assert_eq!(
        hexf32!("0x1.fffffep+31"),
        instance
            .invoke_typed(function, 0xfffffe81_u32 as i32)
            .unwrap()
    );
    assert_eq!(
        hexf32!("0x1.fffffep+31"),
        instance
            .invoke_typed(function, 0xfffffe82_u32 as i32)
            .unwrap()
    );
    assert_eq!(
        16777216.0_f32,
        instance.invoke_typed(function, 16777217).unwrap()
    );
    assert_eq!(
        16777220.0_f32,
        instance.invoke_typed(function, 16777219).unwrap()
    );
}
...
pub fn f32_convert_i64_s() {
    ...
    assert_eq!(1.0_f32, instance.invoke_typed(function, 1_i64).unwrap());
    assert_eq!(-1.0_f32, instance.invoke_typed(function, -1_i64).unwrap());
    assert_eq!(0.0_f32, instance.invoke_typed(function, 0_i64).unwrap());
    assert_eq!(
        9223372036854775807_f32,
        instance
            .invoke_typed(function, 9223372036854775807_i64)
            .unwrap()
    );
    assert_eq!(
        -9223372036854775808_f32,
        instance
            .invoke_typed(function, -9223372036854775808_i64)
            .unwrap()
    );
    assert_eq!(
        hexf32!("0x1.1db9e8p+48"),
        instance
            .invoke_typed(function, 314159265358979_i64)
            .unwrap()
    );
    assert_eq!(
        16777216.0_f32,
        instance.invoke_typed(function, 16777217_i64).unwrap()
    );
    assert_eq!(
        -16777216.0_f32,
        instance.invoke_typed(function, -16777217_i64).unwrap()
    ...
    assert_eq!(
        16777220.0_f32,
        instance.invoke_typed(function, 16777219_i64).unwrap()
    );
    assert_eq!(
        -16777220.0_f32,
        instance.invoke_typed(function, -16777219_i64).unwrap()
    ...
    assert_eq!(
        ...
        instance
            .invoke_typed(function, 0x7fffff4000000001_i64)
            .unwrap()
    );
    assert_eq!(
        hexf32!("-0x1.fffffep+62"),
        instance
            .invoke_typed(function, 0x8000004000000001_u64 as i64)
            .unwrap()
    );
    assert_eq!(
        hexf32!("0x1.000002p+53"),
        instance
            .invoke_typed(function, 0x0020000020000001_i64)
            .unwrap()
    );
    assert_eq!(
        hexf32!("-0x1.000002p+53"),
        instance
            .invoke_typed(function, 0xffdfffffdfffffff_u64 as i64)
            .unwrap()
    );
}
...
pub fn f32_convert_i64_u() {
    ...
    assert_eq!(
        ...
        instance
            .invoke_typed(function, 0xffffffffffffffff_u64 as i64)
            .unwrap()
    );
    ...
    assert_eq!(
        hexf32!("0x1.fffffep+62"),
        instance
            .invoke_typed(function, 0x7fffffbfffffffff_i64)
            .unwrap()
    );
    assert_eq!(
        hexf32!("0x1.000002p+63"),
        instance
            .invoke_typed(function, 0x8000008000000001_u64 as i64)
            .unwrap()
    );
    assert_eq!(
        hexf32!("0x1.fffffep+63"),
        instance
            .invoke_typed(function, 0xfffffe8000000001_u64 as i64)
            .unwrap()
    );
}
...
pub fn f32_demote_f64_let_it_die() {
    ...
    assert_eq!(0.0_f32, instance.invoke_typed(function, 0.0_f64).unwrap());
}
...
pub fn f32_demote_f64() {
    ...
    assert_eq!(1.0_f32, instance.invoke_typed(function, 1.0_f64).unwrap());
    assert_eq!(-1.0_f32, instance.invoke_typed(function, -1.0_f64).unwrap());
    assert_eq!(
        hexf32!("0x1p-126"),
        instance
            .invoke_typed(function, hexf64!("0x1.fffffe0000000p-127"))
            .unwrap()
    );
    assert_eq!(
        hexf32!("-0x1p-126"),
    ...
    assert_eq!(
        ...
        instance
            .invoke_typed(function, hexf64!("0x1.fffffdfffffffp-127"))
            .unwrap()
    );
    assert_eq!(
        hexf32!("-0x1.fffffcp-127"),
    ...
    assert_eq!(
        hexf32!("0x1p-149"),
        instance
            .invoke_typed(function, hexf64!("0x1p-149"))
            .unwrap()
    );
    assert_eq!(
        hexf32!("-0x1p-149"),
    ...
    assert_eq!(
        hexf32!("0x1.fffffcp+127"),
        instance
            .invoke_typed(function, hexf64!("0x1.fffffd0000000p+127"))
            .unwrap()
    );
    assert_eq!(
        hexf32!("-0x1.fffffcp+127"),
    ...
    assert_eq!(
        ...
        instance
            .invoke_typed(function, hexf64!("0x1.fffffd0000001p+127"))
            .unwrap()
    );
    assert_eq!(
        hexf32!("-0x1.fffffep+127"),
    ...
    assert_eq!(
        hexf32!("0x1.fffffep+127"),
        instance
            .invoke_typed(function, hexf64!("0x1.fffffep+127"))
            .unwrap()
    );
    assert_eq!(
        hexf32!("-0x1.fffffep+127"),
    ...
    assert_eq!(
        hexf32!("0x1.fffffep+127"),
        instance
            .invoke_typed(function, hexf64!("0x1.fffffefffffffp+127"))
            .unwrap()
    );
    assert_eq!(
        hexf32!("-0x1.fffffep+127"),
    ...
    assert_eq!(
        f32::INFINITY,
        instance
            .invoke_typed(function, hexf64!("0x1.ffffffp+127"))
            .unwrap()
    );
    assert_eq!(
        f32::NEG_INFINITY,
    ...
    assert_eq!(
        hexf32!("0x1p-119"),
        instance
            .invoke_typed(function, hexf64!("0x1p-119"))
            .unwrap()
    );
    assert_eq!(
        hexf32!("0x1.8f867ep+125"),
        instance
            .invoke_typed(function, hexf64!("0x1.8f867ep+125"))
            .unwrap()
    );
    assert_eq!(
        f32::INFINITY,
        instance.invoke_typed(function, f64::INFINITY).unwrap()
    );
    assert_eq!(
        f32::NEG_INFINITY,
        instance.invoke_typed(function, f64::NEG_INFINITY).unwrap()
    );
    assert_eq!(
        1.0_f32,
        instance
            .invoke_typed(function, hexf64!("0x1.0000000000001p+0"))
            .unwrap()
    );
    assert_eq!(
        1.0_f32,
    ...
    assert_eq!(
        ...
        instance
            .invoke_typed(function, hexf64!("0x1.0000010000000p+0"))
            .unwrap()
    );
    assert_eq!(
        hexf32!("0x1.000002p+0"),
        instance
            .invoke_typed(function, hexf64!("0x1.0000010000001p+0"))
            .unwrap()
    );
    assert_eq!(
        hexf32!("0x1.000002p+0"),
        instance
            .invoke_typed(function, hexf64!("0x1.000002fffffffp+0"))
            .unwrap()
    );
    assert_eq!(
        hexf32!("0x1.000004p+0"),
        instance
            .invoke_typed(function, hexf64!("0x1.0000030000000p+0"))
            .unwrap()
    );
    assert_eq!(
        hexf32!("0x1.000004p+0"),
        instance
            .invoke_typed(function, hexf64!("0x1.0000050000000p+0"))
            .unwrap()
    );
    assert_eq!(
        hexf32!("0x1.0p+24"),
        instance
            .invoke_typed(function, hexf64!("0x1.0000010000000p+24"))
            .unwrap()
    );
    assert_eq!(
        hexf32!("0x1.000002p+24"),
        instance
            .invoke_typed(function, hexf64!("0x1.0000010000001p+24"))
            .unwrap()
    );
    assert_eq!(
        hexf32!("0x1.000002p+24"),
        instance
            .invoke_typed(function, hexf64!("0x1.000002fffffffp+24"))
            .unwrap()
    );
    assert_eq!(
        hexf32!("0x1.000004p+24"),
        instance
            .invoke_typed(function, hexf64!("0x1.0000030000000p+24"))
            .unwrap()
    );
    assert_eq!(
        hexf32!("0x1.4eae5p+108"),
        instance
            .invoke_typed(function, hexf64!("0x1.4eae4f7024c7p+108"))
            .unwrap()
    );
    assert_eq!(
        hexf32!("0x1.a12e72p-113"),
        instance
            .invoke_typed(function, hexf64!("0x1.a12e71e358685p-113"))
            .unwrap()
    );
    assert_eq!(
        hexf32!("0x1.cb9834p-127"),
        instance
            .invoke_typed(function, hexf64!("0x1.cb98354d521ffp-127"))
            .unwrap()
    );
    assert_eq!(
        hexf32!("-0x1.6972b4p+1"),
        instance
            .invoke_typed(function, hexf64!("-0x1.6972b30cfb562p+1"))
            .unwrap()
    );
    assert_eq!(
        hexf32!("-0x1.bedbe4p+112"),
        instance
            .invoke_typed(function, hexf64!("-0x1.bedbe4819d4c4p+112"))
            .unwrap()
    );
    ...
    assert_eq!(
        0.0_f32,
        instance
            .invoke_typed(function, hexf64!("0x1p-1022"))
            .unwrap()
    );
    assert_eq!(
        -0.0_f32,
    ...
    assert_eq!(
        0.0_f32,
        instance
            .invoke_typed(function, hexf64!("0x1.0p-150"))
            .unwrap()
    );
    assert_eq!(
        -0.0_f32,
    ...
    assert_eq!(
        hexf32!("0x1p-149"),
        instance
            .invoke_typed(function, hexf64!("0x1.0000000000001p-150"))
            .unwrap()
    );
    assert_eq!(
        hexf32!("-0x1p-149"),
...
pub fn f64_convert_i32_s() {
    ...
    assert_eq!(1.0_f64, instance.invoke_typed(function, 1).unwrap());
    assert_eq!(-1.0_f64, instance.invoke_typed(function, -1).unwrap());
    assert_eq!(0.0_f64, instance.invoke_typed(function, 0).unwrap());
    assert_eq!(
        2147483647_f64,
        instance.invoke_typed(function, 2147483647).unwrap()
    );
    ...
    assert_eq!(
        987654321_f64,
        instance.invoke_typed(function, 987654321).unwrap()
    );
}
...
pub fn f64_convert_i64_s() {
    ...
    assert_eq!(1.0_f64, instance.invoke_typed(function, 1_i64).unwrap());
    assert_eq!(-1.0_f64, instance.invoke_typed(function, -1_i64).unwrap());
    assert_eq!(0.0_f64, instance.invoke_typed(function, 0_i64).unwrap());
    assert_eq!(
    ...
    assert_eq!(
        ...
        instance
            .invoke_typed(function, 4669201609102990_i64)
            .unwrap()
    );
    assert_eq!(
        9007199254740992_f64,
        instance
            .invoke_typed(function, 9007199254740993_i64)
            .unwrap()
    );
    assert_eq!(
        -9007199254740992_f64,
    ...
    assert_eq!(
        ...
        instance
            .invoke_typed(function, 9007199254740995_i64)
            .unwrap()
    );
    assert_eq!(
        -9007199254740996_f64,
...
pub fn f64_convert_i64_u() {
    ...
    assert_eq!(
        ...
        instance
            .invoke_typed(function, 0x8000000000000400_u64 as i64)
            .unwrap()
    );
    assert_eq!(
        hexf64!("0x1.0000000000001p+63"),
        instance
            .invoke_typed(function, 0x8000000000000401_u64 as i64)
            .unwrap()
    );
    assert_eq!(
        hexf64!("0x1.0000000000001p+63"),
        instance
            .invoke_typed(function, 0x8000000000000402_u64 as i64)
            .unwrap()
    );
    assert_eq!(
        hexf64!("0x1.ffffffffffffep+63"),
        instance
            .invoke_typed(function, 0xfffffffffffff400_u64 as i64)
            .unwrap()
    );
    assert_eq!(
        hexf64!("0x1.fffffffffffffp+63"),
        instance
            .invoke_typed(function, 0xfffffffffffff401_u64 as i64)
            .unwrap()
    );
    assert_eq!(
        hexf64!("0x1.fffffffffffffp+63"),
        instance
            .invoke_typed(function, 0xfffffffffffff402_u64 as i64)
            .unwrap()
    );
    // ;; Test rounding directions.
    assert_eq!(
...
pub fn f64_promote_f32() {
    ...
    assert_eq!(0.0_f64, instance.invoke_typed(function, 0.0_f32).unwrap());
    assert_eq!(-0.0_f64, instance.invoke_typed(function, -0.0_f32).unwrap());
    assert_eq!(
        hexf64!("0x1p-149"),
        instance
    ...
    assert_eq!(1.0_f64, instance.invoke_typed(function, 1.0_f32).unwrap());
    assert_eq!(-1.0_f64, instance.invoke_typed(function, -1.0_f32).unwrap());
    assert_eq!(
        hexf64!("-0x1.fffffep+127"),
        instance
            .invoke_typed(function, hexf32!("-0x1.fffffep+127"))
            .unwrap()
    );
    assert_eq!(
        hexf64!("0x1.fffffep+127"),
    ...
    assert_eq!(
        hexf64!("0x1p-119"),
        instance
            .invoke_typed(function, hexf32!("0x1p-119"))
            .unwrap()
    );
    assert_eq!(
        6.638_253_671_010_439_5e37_f64,
        instance
            .invoke_typed(function, hexf32!("0x1.8f867ep+125"))
            .unwrap()
    );
    assert_eq!(
        f64::INFINITY,
        instance.invoke_typed(function, f32::INFINITY).unwrap()
    );
    assert_eq!(
        f64::NEG_INFINITY,
        instance.invoke_typed(function, f32::NEG_INFINITY).unwrap()
    );
...
pub fn i32_reinterpret_f32() {
    ...
    assert_eq!(
        0x80000000_u32 as i32,
        instance.invoke_typed(function, -0.0_f32).unwrap()
    );
    assert_eq!(
        1,
        instance
    ...
    assert_eq!(
        1065353216,
        instance.invoke_typed(function, 1.0_f32).unwrap()
    );
    assert_eq!(
        1078530010,
        instance.invoke_typed(function, 3.1415926_f32).unwrap()
    );
    assert_eq!(
        2139095039,
        instance
    ...
    assert_eq!(
        0x7fc00000,
        instance.invoke_typed(function, f32::NAN).unwrap()
    );
    assert_eq!(
...
pub fn i64_reinterpret_f64() {
    ...
    assert_eq!(
        ...
        instance.invoke_typed(function, -0.0_f64).unwrap()
    );
    assert_eq!(
        1_i64,
        instance
    ...
    assert_eq!(
        ...
        instance.invoke_typed(function, 1.0_f64).unwrap()
    );
    assert_eq!(
        4614256656552045841_i64,
        instance
            .invoke_typed(function, 3.14159265358979_f64)
            .unwrap()
    );
    assert_eq!(
        9218868437227405311_i64,
        instance
            .invoke_typed(function, hexf64!("0x1.fffffffffffffp+1023"))
            .unwrap()
    );
    assert_eq!(
    ...
    assert_eq!(
        ...
        instance.invoke_typed(function, f64::NAN).unwrap()
    );
    assert_eq!(
...
pub fn f32_reinterpret_i32() {
    ...
    assert_eq!(
        f32::INFINITY,
        instance.invoke_typed(function, 0x7f800000).unwrap()
    );
    assert_eq!(
        f32::NEG_INFINITY,
        instance
            .invoke_typed(function, 0xff800000_u32 as i32)
            .unwrap()
    );
    {
        let result: f32 = instance.invoke_typed(function, 0x7fc00000).unwrap();
        assert!(result.is_nan());
        assert!(result.is_sign_positive());
    }
    {
        let result: f32 = instance
            .invoke_typed(function, 0xffc00000_u32 as i32)
            .unwrap();
        assert!(result.is_nan());
...
pub fn f64_reinterpret_i64() {
    ...
    assert_eq!(
        ...
        instance.invoke_typed(function, 1_i64).unwrap()
    );
    // (assert_return (invoke "f64.reinterpret_i64" (i64.const -1)) (f64.const -nan:0xfffffffffffff))
    assert_eq!(
        -0.0_f64,
        instance
            .invoke_typed(function, 0x8000000000000000_u64 as i64)
            .unwrap()
    );
    assert_eq!(
        hexf64!("0x0.00000499602d2p-1022"),
        instance.invoke_typed(function, 1234567890_i64).unwrap()
    );
    assert_eq!(
        hexf64!("-0x0.0000000000001p-1022"),
        instance
    ...
    assert_eq!(
        f64::INFINITY,
        instance
            .invoke_typed(function, 0x7ff0000000000000_u64 as i64)
            .unwrap()
    );
    assert_eq!(
        f64::NEG_INFINITY,
        instance
            .invoke_typed(function, 0xfff0000000000000_u64 as i64)
            .unwrap()
    );
    {
        let result: f64 = instance
            .invoke_typed(function, 0x7ff8000000000000_u64 as i64)
            .unwrap();
        assert!(result.is_nan());
        assert!(result.is_sign_positive());
    }
    {
        let result: f64 = instance
            .invoke_typed(function, 0xfff8000000000000_u64 as i64)
            .unwrap();
        assert!(result.is_nan());
        assert!(result.is_sign_negative());
    }
