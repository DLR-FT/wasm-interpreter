...
pub fn i32_wrap_i64() {
    ...
    assert_eq!(
        ...
        instance
            .store
            .invoke_typed_without_fuel(function, -1_i64)
            .unwrap()
    );
    assert_eq!(
        -100000,
...
pub fn i32_trunc_f64_s() {
    ...
    assert_eq!(
        ...
        instance
            .store
            .invoke_typed_without_fuel(function, 1.0_f64)
            .unwrap()
    );
    assert_eq!(
        1,
    ...
    assert_eq!(
        ...
        instance
            .store
            .invoke_typed_without_fuel(function, -1.9_f64)
            .unwrap()
    );
    assert_eq!(
        -2,
...
pub fn i32_trunc_f64_u() {
    ...
    assert_eq!(
        ...
        instance
            .store
            .invoke_typed_without_fuel(function, -0.9)
            .unwrap()
    );
    assert_eq!(
...
pub fn i64_extend_i32_s() {
    ...
    assert_eq!(
        ...
        instance
            .store
            .invoke_typed_without_fuel(function, 10000)
            .unwrap()
    );
    assert_eq!(
        -10000_i64,
...
pub fn f32_convert_i32_u() {
    ...
    assert_eq!(
        ...
        instance
            .store
            .invoke_typed_without_fuel(function, 16777217)
            .unwrap()
    );
    assert_eq!(
        16777220.0_f32,
        instance
            .store
            .invoke_typed_without_fuel(function, 16777219)
            .unwrap()
    );
}
...
pub fn f32_demote_f64() {
    ...
    // assert_eq!(f32::NAN, instance.store.invoke_typed_without_fuel(instance.get_fn_idx(0, 0).unwrap(), f64::NAN).unwrap());
