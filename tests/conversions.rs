...
pub fn i32_trunc_f32_s() {
    ...
    assert_eq!(
        ...
        instance
            .invoke_typed::<f32, i32>(instance.get_function_by_index(module, 0).unwrap(), f32::NAN)
            .err()
            .unwrap()
    );
    assert_eq!(
...
pub fn i32_trunc_f32_u() {
    ...
    assert_eq!(
        RuntimeError::Trap(TrapError::UnrepresentableResult),
        instance
            .invoke_typed::<f32, i32>(instance.get_function_by_index(module, 0).unwrap(), -1.0)
            .err()
            .unwrap()
    );
    assert_eq!(
...
pub fn i32_trunc_f64_s() {
    ...
    assert_eq!(
        1,
        instance
            .invoke_typed(instance.get_function_by_index(module, 0).unwrap(), 1.0_f64)
            .unwrap()
    );
    assert_eq!(
        1,
    ...
    assert_eq!(
        -1,
        instance
            .invoke_typed(instance.get_function_by_index(module, 0).unwrap(), -1.9_f64)
            .unwrap()
    );
    assert_eq!(
        -2,
    ...
    assert_eq!(
        RuntimeError::Trap(TrapError::BadConversionToInteger),
        instance
            .invoke_typed::<f64, i32>(instance.get_function_by_index(module, 0).unwrap(), f64::NAN)
            .err()
            .unwrap()
    );
    assert_eq!(
...
pub fn i32_trunc_f64_u() {
    ...
    assert_eq!(
        0,
        instance
            .invoke_typed(instance.get_function_by_index(module, 0).unwrap(), -0.9)
            .unwrap()
    );
    assert_eq!(
    ...
    assert_eq!(
        RuntimeError::Trap(TrapError::UnrepresentableResult),
        instance
            .invoke_typed::<f64, i32>(instance.get_function_by_index(module, 0).unwrap(), -1.0)
            .err()
            .unwrap()
    );
    assert_eq!(
        RuntimeError::Trap(TrapError::UnrepresentableResult),
        instance
            .invoke_typed::<f64, i32>(instance.get_function_by_index(module, 0).unwrap(), 1e16)
            .err()
            .unwrap()
    );
    assert_eq!(
        RuntimeError::Trap(TrapError::UnrepresentableResult),
        instance
            .invoke_typed::<f64, i32>(instance.get_function_by_index(module, 0).unwrap(), 1e30)
            .err()
            .unwrap()
    );
    assert_eq!(
...
pub fn i64_extend_i32_s() {
    ...
    assert_eq!(
        10000_i64,
        instance
            .invoke_typed(instance.get_function_by_index(module, 0).unwrap(), 10000)
            .unwrap()
    );
    assert_eq!(
        -10000_i64,
...
pub fn i64_trunc_f32_s() {
    ...
    assert_eq!(
        RuntimeError::Trap(TrapError::BadConversionToInteger),
        instance
            .invoke_typed::<f32, i64>(instance.get_function_by_index(module, 0).unwrap(), f32::NAN)
            .err()
            .unwrap()
    );
    assert_eq!(
...
pub fn i64_trunc_f32_u() {
    ...
    assert_eq!(
        RuntimeError::Trap(TrapError::UnrepresentableResult),
        instance
            .invoke_typed::<f32, i64>(instance.get_function_by_index(module, 0).unwrap(), -1.0_f32)
            .err()
            .unwrap()
    );
    assert_eq!(
...
pub fn i64_trunc_f64_s() {
    ...
    assert_eq!(
        RuntimeError::Trap(TrapError::BadConversionToInteger),
        instance
            .invoke_typed::<f64, i64>(instance.get_function_by_index(module, 0).unwrap(), f64::NAN)
            .err()
            .unwrap()
    );
    assert_eq!(
...
pub fn i64_trunc_f64_u() {
    ...
    assert_eq!(
        RuntimeError::Trap(TrapError::UnrepresentableResult),
        instance
            .invoke_typed::<f64, i64>(instance.get_function_by_index(module, 0).unwrap(), -1_f64)
            .err()
            .unwrap()
    );
    assert_eq!(
...
pub fn f32_convert_i32_u() {
    ...
    assert_eq!(
        16777216.0_f32,
        instance
            .invoke_typed(instance.get_function_by_index(module, 0).unwrap(), 16777217)
            .unwrap()
    );
    assert_eq!(
        16777220.0_f32,
        instance
            .invoke_typed(instance.get_function_by_index(module, 0).unwrap(), 16777219)
            .unwrap()
    );
}
