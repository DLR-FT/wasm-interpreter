...
pub fn f64_eq() {
    ...
    assert_eq!(
        1,
        store
            .invoke_simple_typed(function, (1.1_f64, 1.1_f64))
            .unwrap()
    );
    assert_eq!(
        0,
        store
            .invoke_simple_typed(function, (1.1_f64, 1.2_f64))
            .unwrap()
    );
}
...
pub fn f64_ne() {
    ...
    assert_eq!(
        0,
        store
            .invoke_simple_typed(function, (0.0_f64, -0.0_f64))
            .unwrap()
    );
}
...
pub fn f64_lt() {
    ...
    assert_eq!(
        1,
        store
            .invoke_simple_typed(function, (1.0_f64, 2.0_f64))
            .unwrap()
    );
    assert_eq!(
        0,
        store
            .invoke_simple_typed(function, (2.0_f64, 1.0_f64))
            .unwrap()
    );
    assert_eq!(
        0,
        store
            .invoke_simple_typed(function, (1.0_f64, 1.0_f64))
            .unwrap()
    );
}
...
pub fn f64_abs() {
    ...
    {
        let result = store
            .invoke_simple_typed::<f64, f64>(function, -f64::NAN)
            .unwrap();
    ...
    {
        let result = store
            .invoke_simple_typed::<f64, f64>(function, f64::NEG_INFINITY)
            .unwrap();
    ...
    {
        let result = store
            .invoke_simple_typed::<f64, f64>(function, f64::INFINITY)
            .unwrap();
        assert!(result.is_infinite());
        assert!(result.is_sign_positive());
    }
...
pub fn f64_ceil() {
    ...
    assert_eq!(
        0.0_f64,
        store.invoke_simple_typed(function, -0.1_f64).unwrap()
    );
}
...
pub fn f64_trunc() {
    ...
    assert_eq!(
        0.0_f64,
        store.invoke_simple_typed(function, 0.9_f64).unwrap()
    );
}
...
pub fn f64_nearest() {
    ...
    assert_eq!(
        1.0_f64,
        store.invoke_simple_typed(function, 0.6_f64).unwrap()
    );
    assert_eq!(
        0.0_f64,
        store.invoke_simple_typed(function, 0.4_f64).unwrap()
    );
}
...
pub fn f64_sqrt() {
    ...
    assert_eq!(
        2.0_f64,
        store.invoke_simple_typed(function, 4.0_f64).unwrap()
    );
    assert_eq!(
...
pub fn f64_add() {
    ...
    assert_eq!(
        3.0_f64,
        store
            .invoke_simple_typed(function, (1.5_f64, 1.5_f64))
            .unwrap()
    );
    assert_eq!(
        -1.0_f64,
    ...
    assert_eq!(
        0.0_f64,
        store
            .invoke_simple_typed(function, (0.1_f64, -0.1_f64))
            .unwrap()
    );
}
...
pub fn f64_mul() {
    ...
    assert_eq!(
        6.0_f64,
        store
            .invoke_simple_typed(function, (2.0_f64, 3.0_f64))
            .unwrap()
    );
    assert_eq!(
        -4.0_f64,
        store
            .invoke_simple_typed(function, (2.0_f64, -2.0_f64))
            .unwrap()
    );
    assert_eq!(
        0.0_f64,
        store
            .invoke_simple_typed(function, (0.0_f64, 5.0_f64))
            .unwrap()
    );
}
...
pub fn f64_div() {
    ...
    assert_eq!(
        2.0_f64,
        store
            .invoke_simple_typed(function, (6.0_f64, 3.0_f64))
            .unwrap()
    );
    assert_eq!(
        -1.0_f64,
    ...
    assert!(store
        .invoke_simple_typed::<(f64, f64), f64>(function, (1.0_f64, 0.0_f64))
        .unwrap()
        .is_infinite());
    assert!(store
        .invoke_simple_typed::<(f64, f64), f64>(function, (0.0_f64, 0.0_f64))
        .unwrap()
        .is_nan());
}
...
pub fn f64_min() {
    ...
    {
        let result = store
            .invoke_simple_typed::<(f64, f64), f64>(function, (f64::NAN, -f64::NAN))
            .unwrap();
        assert!(result.is_nan());
    }
    {
    ...
    {
        let result = store
            .invoke_simple_typed::<(f64, f64), f64>(function, (f64::INFINITY, f64::NEG_INFINITY))
            .unwrap();
        assert!(result.is_infinite());
        assert!(result.is_sign_negative());
    }
    assert_eq!(
        42_f64,
        store
            .invoke_simple_typed(function, (f64::INFINITY, 42_f64))
            .unwrap()
    );
    assert_eq!(
        -0_f64,
        store
            .invoke_simple_typed(function, (-0_f64, 0_f64))
            .unwrap()
    );
    assert_eq!(
        1.0_f64,
    ...
    assert!(store
        .invoke_simple_typed::<(f64, f64), f64>(function, (f64::NAN, 1.0_f64))
        .unwrap()
        .is_nan());
}
...
pub fn f64_max() {
    ...
    assert_eq!(
        42_f64,
        store
            .invoke_simple_typed(function, (f64::NEG_INFINITY, 42_f64))
            .unwrap()
    );
    assert_eq!(
        0_f64,
...
pub fn f64_copysign() {
    ...
    assert_eq!(
        1.5_f64,
        store
            .invoke_simple_typed(function, (1.5_f64, 2.0_f64))
            .unwrap()
    );
    assert_eq!(
        -1.5_f64,
    ...
    assert_eq!(
        -1.5_f64,
        store
            .invoke_simple_typed(function, (-1.5_f64, -0.0_f64))
            .unwrap()
    );
    assert_eq!(
        1.5_f64,
