...
pub fn i32_bitwise_clz() {
    ...
    assert_eq!(
        26,
        instance
            .invoke_typed(&instance.get_function_by_index(module_addr, 0).unwrap(), 33)
            .unwrap()
    );
    assert_eq!(
        25,
        instance
            .invoke_typed(&instance.get_function_by_index(module_addr, 0).unwrap(), 77)
            .unwrap()
    );
    assert_eq!(
        14,
    ...
    assert_eq!(
        32,
        instance
            .invoke_typed(&instance.get_function_by_index(module_addr, 0).unwrap(), 0)
            .unwrap()
    );
}
