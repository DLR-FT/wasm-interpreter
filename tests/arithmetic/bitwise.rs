...
pub fn i32_bitwise_and() {
    ...
    let function = store
        .instance_export_checked(module, "template")
        .unwrap()
        .as_func()
        .unwrap();
    ...
    assert_eq!(
        1,
        store
            .invoke_typed_without_fuel_checked(function, (33, 11))
            .unwrap()
    );
    assert_eq!(
        5,
        store
            .invoke_typed_without_fuel_checked(function, (77, 23))
            .unwrap()
    );
    assert_eq!(
        180244,
        store
            .invoke_typed_without_fuel_checked(function, (192534, 1231412))
            .unwrap()
    );
    assert_eq!(
        0,
        store
            .invoke_typed_without_fuel_checked(function, (i32::MIN, i32::MAX))
            .unwrap()
    );
}
...
pub fn i32_bitwise_shr_s() {
    ...
    assert_eq!(
        8881445,
        store
            .invoke_typed_without_fuel_checked(function, (142_103_123, 4))
            .unwrap()
    );
    assert_eq!(
        23879,
        store
            .invoke_typed_without_fuel_checked(function, (391_248_921, 14))
            .unwrap()
    );
    assert_eq!(
        601955006,
        store
            .invoke_typed_without_fuel_checked(function, (1_203_910_012, 33))
            .unwrap()
    );
    assert_eq!(
        1056594615,
        store
            .invoke_typed_without_fuel_checked(function, (2_113_189_231, 33))
            .unwrap()
    );
    assert_eq!(
        -1,
    ...
    assert_eq!(
        4,
        store
            .invoke_typed_without_fuel_checked(function, (8, 1))
            .unwrap()
    );
    ...
    assert_eq!(
        -1,
        store
            .invoke_typed_without_fuel_checked(function, (-1, 0))
            .unwrap()
    );
    assert_eq!(
        1,
    ...
    assert_eq!(
        -1,
        store
            .invoke_typed_without_fuel_checked(function, (-1, 1))
            .unwrap()
    );
    ...
    assert_eq!(
        -1,
        store
            .invoke_typed_without_fuel_checked(function, (-1, 31))
            .unwrap()
    );
    assert_eq!(
        -1,
        store
            .invoke_typed_without_fuel_checked(function, (i32::MIN, 31))
            .unwrap()
    );
    assert_eq!(
        0,
        store
            .invoke_typed_without_fuel_checked(function, (i32::MAX, 31))
            .unwrap()
    );
    ...
    assert_eq!(
        -1,
        store
            .invoke_typed_without_fuel_checked(function, (-1, 32))
            .unwrap()
    );
    assert_eq!(
        1,
    ...
    assert_eq!(
        -1,
        store
            .invoke_typed_without_fuel_checked(function, (-1, 100))
            .unwrap()
    );
    ...
    assert_eq!(
        i32::MIN / 2,
        store
            .invoke_typed_without_fuel_checked(function, (i32::MIN, 1))
            .unwrap()
    );
    assert_eq!(
        i32::MAX / 2,
        store
            .invoke_typed_without_fuel_checked(function, (i32::MAX, 1))
            .unwrap()
    );
    ...
    assert_eq!(
        -2,
        store
            .invoke_typed_without_fuel_checked(function, (i32::MIN, 30))
            .unwrap()
    );
    assert_eq!(
        1,
        store
            .invoke_typed_without_fuel_checked(function, (i32::MAX, 30))
            .unwrap()
    );
}
...
pub fn i32_bitwise_clz() {
    ...
    assert_eq!(
        26,
        store
            .invoke_typed_without_fuel_checked(function, 33)
            .unwrap()
    );
    assert_eq!(
        25,
        store
            .invoke_typed_without_fuel_checked(function, 77)
            .unwrap()
    );
    assert_eq!(
        14,
        store
            .invoke_typed_without_fuel_checked(function, 192534)
            .unwrap()
    );
    assert_eq!(
        0,
        store
            .invoke_typed_without_fuel_checked(function, i32::MIN)
            .unwrap()
    );
    assert_eq!(
        1,
        store
            .invoke_typed_without_fuel_checked(function, i32::MAX)
            .unwrap()
    );
    assert_eq!(
        32,
...
pub fn i64_bitwise_and() {
    ...
    assert_eq!(
        1_i64,
        store
            .invoke_typed_without_fuel_checked(function, (33_i64, 11_i64))
            .unwrap()
    );
    assert_eq!(
        5_i64,
        store
            .invoke_typed_without_fuel_checked(function, (77_i64, 23_i64))
            .unwrap()
    );
    assert_eq!(
        180244_i64,
        store
            .invoke_typed_without_fuel_checked(function, (192534_i64, 1231412_i64))
            .unwrap()
    );
    assert_eq!(
        0_i64,
        store
            .invoke_typed_without_fuel_checked(function, (i64::MIN, i64::MAX))
            .unwrap()
    );
}
...
pub fn i64_bitwise_shr_s() {
    ...
    assert_eq!(
        8881445_i64,
        store
            .invoke_typed_without_fuel_checked(function, (142_103_123_i64, 4_i64))
            .unwrap()
    );
    assert_eq!(
        23879_i64,
        store
            .invoke_typed_without_fuel_checked(function, (391_248_921_i64, 14_i64))
            .unwrap()
    );
    assert_eq!(
        0_i64,
        store
            .invoke_typed_without_fuel_checked(function, (1_203_910_012_i64, 33_i64))
            .unwrap()
    );
    assert_eq!(
        0_i64,
        store
            .invoke_typed_without_fuel_checked(function, (2_113_189_231_i64, 33_i64))
            .unwrap()
    );
    assert_eq!(
        -1_i64,
    ...
    assert_eq!(
        4_i64,
        store
            .invoke_typed_without_fuel_checked(function, (8_i64, 1_i64))
            .unwrap()
    );
    ...
    assert_eq!(
        -1_i64,
        store
            .invoke_typed_without_fuel_checked(function, (-1_i64, 31_i64))
            .unwrap()
    );
    assert_eq!(
        -4294967296_i64,
        store
            .invoke_typed_without_fuel_checked(function, (i64::MIN, 31_i64))
            .unwrap()
    );
    assert_eq!(
        4294967295_i64,
        store
            .invoke_typed_without_fuel_checked(function, (i64::MAX, 31_i64))
            .unwrap()
    );
    ...
    assert_eq!(
        -1_i64,
        store
            .invoke_typed_without_fuel_checked(function, (-1_i64, 32_i64))
            .unwrap()
    );
    assert_eq!(
        0_i64,
    ...
    assert_eq!(
        -1_i64,
        store
            .invoke_typed_without_fuel_checked(function, (-1_i64, 100_i64))
            .unwrap()
    );
    ...
    assert_eq!(
        i64::MIN / 2,
        store
            .invoke_typed_without_fuel_checked(function, (i64::MIN, 1_i64))
            .unwrap()
    );
    assert_eq!(
        i64::MAX / 2,
        store
            .invoke_typed_without_fuel_checked(function, (i64::MAX, 1_i64))
            .unwrap()
    );
    ...
    assert_eq!(
        -8589934592_i64,
        store
            .invoke_typed_without_fuel_checked(function, (i64::MIN, 30_i64))
            .unwrap()
    );
    assert_eq!(
        8589934591_i64,
        store
            .invoke_typed_without_fuel_checked(function, (i64::MAX, 30_i64))
            .unwrap()
    );
}
...
pub fn i64_bitwise_clz() {
    ...
    assert_eq!(
        58_i64,
        store
            .invoke_typed_without_fuel_checked(function, 33_i64)
            .unwrap()
    );
    assert_eq!(
        57_i64,
        store
            .invoke_typed_without_fuel_checked(function, 77_i64)
            .unwrap()
    );
    assert_eq!(
        46_i64,
        store
            .invoke_typed_without_fuel_checked(function, 192534_i64)
            .unwrap()
    );
    assert_eq!(
        0_i64,
        store
            .invoke_typed_without_fuel_checked(function, i64::MIN)
            .unwrap()
    );
    assert_eq!(
        1_i64,
        store
            .invoke_typed_without_fuel_checked(function, i64::MAX)
            .unwrap()
    );
    assert_eq!(
        64_i64,
