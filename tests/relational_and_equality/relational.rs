...
/// A simple function to test the i32.ge_s function
#[test_log::test]
pub fn i32_ge_s() {
    let wat = String::from(BASE_WAT).replace("{{0}}", "ge_s");
...
/// A simple function to test the i32.ge_u function
#[test_log::test]
pub fn i32_ge_u() {
    let wat = String::from(BASE_WAT).replace("{{0}}", "ge_u");
