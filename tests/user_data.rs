...
use wasm::{HaltExecutionError, RuntimeInstance, Value};

#[test_log::test]
fn counter() {
    fn add_one(user_data: &mut u32, _params: Vec<Value>) -> Result<Vec<Value>, HaltExecutionError> {
        *user_data += 1;
